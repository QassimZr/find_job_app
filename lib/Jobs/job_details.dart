...
import 'package:find_job_app/Widgets/comments_widget.dart';
  ...
  void getJobData() async
  {
    ...
    if(jobDatabase == null)
      ...
      setState(() {
        ...
        jobDescription = jobDatabase.get('jobDescription'); // Corrected line
                                        ...
                                        child: MaterialButton(
                                          onPressed: () async {
                                            if(_commentController.text.length < 3)
                                              {
                                                GlobalMethod.showErrorDialog(
                                                  error: 'Comment cannot be less the 3 characters',
                                                  ctx: context,
                                                );
                                              }
                                            else
                              ...
                              Row(
                                ...
                                children: [
                                  IconButton(
                                    ...
                                    icon: const Icon(Icons.arrow_drop_down, color: Colors.blueAccent, size: 40,),
                                  ),
                                  const SizedBox(width: 10,),
                                  IconButton(
                                    onPressed: (){
